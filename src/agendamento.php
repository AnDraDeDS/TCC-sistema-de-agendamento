        ...
        <div class="content_agenda d-none">
                ...
                <div class="aside">
                    ...
                    <div class="horarios">
                        ...
                        <button type="button" class="horario" name="horario" vlaue="08:00 - 09:30" id="hora1">08:00 - 09:30</button>
                        <button type="button" class="horario" name="horario" vlaue="09:30 - 11:00" id="hora2">09:30 - 11:00</button>
                        <button type="button" class="horario" name="horario" vlaue="11:00 - 12:30" id="hora3">11:00 - 12:30</button>
                        <button type="button" class="horario" name="horario" vlaue="12:30 - 14:00" id="hora4">12:30 - 14:00</button>
                        <button type="button" class="horario" name="horario" vlaue="14:00 - 15:30" id="hora5">14:00 - 15:30</button>
                        <button type="button" class="horario" name="horario" vlaue="15:30 - 17:00" id="hora6">15:30 - 17:00</button>
                    </div>
                    <div class="line"></div>
                    
                    <div class="veiculos">
                        <h1 id="title">VEÍCULOS</h1>
                        <button type="button" class="veiculo" name="veiculo" value="moto" id="moto"><img src="./images/icons/agendamento/moto.svg"></button>
                        <button type="button" class="veiculo" name="veiculo" value="carro" id="carro"><img src="./images/icons/agendamento/carro.svg"></button>
                        <button type="button" class="veiculo" name="veiculo" value="caminhonete" id="caminhonete"><img src="./images/icons/agendamento/caminhonete.svg"></button>
                    </div>
